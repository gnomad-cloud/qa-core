...
export class VarsDialect extends Dialect {
	...
	constructor(protected engine: Engine) {
		...
		let doc = this.define(["I clear variables", "I reset variables"], function (this: any, done: Function) {
			for (let name in this) delete this[name];
			done();
		}, new DialectDocs("vars.define", "Working with variables"));
	   ...
	   */
        ...
        }, new DialectDocs("vars.block", "Set variables from block of formatted text"));
