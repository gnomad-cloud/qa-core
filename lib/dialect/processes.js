 ...
 *
 */
class ProcessesDialect extends Dialect_1.Dialect {
    constructor(engine) {
        super(engine);
        this.define(["I run $filename"], function (command, done) {
        ...
        this.define(["I exec $command"], function (command, done) {
        ...
        this.define(["I emit $event"], function (event, done) {
            engine.emit(event, engine.vars);
            done();
        });
        this.define(["I emit $event with $varlist"], function (event, varlist, done) {
...
exports.ProcessesDialect = ProcessesDialect;
