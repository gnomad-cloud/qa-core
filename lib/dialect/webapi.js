...
class WebAPIDialect extends Dialect_1.Dialect {
    ...
    install() {
         ...
         */
        this.define(["I set $header header to $value", "I set header $header = $value"], function (name, value, done) {
        ...
        this.define(["I require client certificates"], function (done) {
            this.request.requestCert = true;
            done();
        });
        this.define(["I don't require client certificates"], function (done) {
        ...
        this.define("I POST $resource", function (resource, done) {
            ...
            request(this.request, (_err, _response, _body) => {
                console.log("POSTED: ....");
                http_1.HTTP.handleResponse(this, done);
            });
        });
        /**
