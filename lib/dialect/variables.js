...
class VarsDialect extends Dialect_1.Dialect {
    constructor(engine) {
         ...
         */
        this.define(["I clear variables", "I reset variables"], function (done) {
        ...
        this.define(["I convert $varname to text"], function (name, done) {
            ...
            vars_1.Vars.set(this, name, JSON.stringify(original));
            done();
        });
        /**
       ...
       */
        ...
        this.define(["dump $varname", "I dump $varname"], function (name, done) {
            ...
            console.log("DUMP: %s ==> %o", name, (found || "Not Found"));
            done();
        });
