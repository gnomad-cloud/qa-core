...
class VarsDialect extends Dialect_1.Dialect {
    constructor(engine) {
       ...
       */
        ...
        this.define(["I merge $varnames as $varname2", "I merge $varnames into $varname2"], function (varnames, varname2, done) {
            ...
            vars_1.Vars.set(this, varname2, result);
            done();
        }, doc);
        /**
